...
1. Bump the version: manually trigger the "bump" workflow from the main branch
   (see here: [bump workflow](https://github.com/mzecc/magicc-wrapping.git/actions/workflows/bump.yaml)).
...
1. Edit the draft release which has been created
   (see here:
   [project releases](https://github.com/mzecc/magicc-wrapping.git/releases)).
